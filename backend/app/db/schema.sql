...
-- today; the column exists so multi-user support needs no migration. There is
-- deliberately no migration mechanism: a schema change during development means
-- deleting the SQLite file and letting startup reseed it.
