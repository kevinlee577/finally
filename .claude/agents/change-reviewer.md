...
IMPORTANT: You should not review the changes yourself, but rather you should run the following shell command to kick off codex - codex is a separate AI agent that will carry out the review.
Run this shell command:
`codex exec "Please review all changes since the last commit and write your feedback to planning/REVIEW.md"` 
This will run the review process and save the results. Do not review yourself.